...
export default function TokenSaleForm({
  ...
  return (
    <div className="flex w-full h-fit items-center justify-center lg:justify-start mt-[10vh] z-50">
      <Card className="bg-e3mel-ice border-[#FFCDFF] rounded-3xl w-full md:w-[525px] h-full flex flex-col items-center gap-4 p-8">
        {/* Title */}
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Link href={BUY_TOKEN_URL} target="_blank" className="w-full">
              <Button className="py-4 w-full text-md gap-4 flex-1 cursor-pointer">
                <div>Buy ${TOKEN_SYMBOL}</div>
